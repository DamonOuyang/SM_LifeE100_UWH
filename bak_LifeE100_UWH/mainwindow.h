...
private slots:
    ...
    void on_monTabWidget_currentChanged(int index);
...
private:
	...
	void SetWaterWidgetBg(bool bOpen);
	...
	void ClosePumCleanAlm(UINT8 unDevType);
