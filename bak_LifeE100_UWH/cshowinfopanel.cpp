    ...
    QFrame(parent)
{
	...
	//m_pShwInfo->setGeometry(QRect(0, 0, 1075, 520));
    ...
    QPushButton* pClearBut = new QPushButton(tr(""));
	pClearBut->setObjectName(QString::fromUtf8("pClearBut"));
	pClearBut->setStyleSheet(QString::fromUtf8("#pClearBut:focus{outline: none;\n"
    "}"));
	QIcon icon;
	icon.addFile(QString::fromUtf8(":/images/clearBut_Bt.png"), QSize(), QIcon::Normal, QIcon::Off);
	pClearBut->setIcon(icon);
	pClearBut->setIconSize(QSize(160, 60));
	
    m_pStopBut  = new QPushButton(tr(""));
	m_pStopBut->setObjectName(QString::fromUtf8("m_pStopBut"));
	m_pStopBut->setStyleSheet(QString::fromUtf8("#m_pStopBut:focus{outline: none;\n"
    "}"));
	QIcon icon1;
	icon1.addFile(QString::fromUtf8(":/images/stopBut_Bt.png"), QSize(), QIcon::Normal, QIcon::Off);
	m_pStopBut->setIcon(icon1);
	m_pStopBut->setIconSize(QSize(160, 60));	

    pClearBut->setMinimumSize(160, 60);
    m_pStopBut->setMinimumSize(160, 60);
