...
void SetValDialog::SetValTextColor(unsigned char onTitle)
{
	switch(onTitle)
	{
	    case 0://水
			ui->lineEdit->setStyleSheet(QLatin1String("#lineEdit{\n"
...
void SetValDialog::SetValLimit(UINT32 unMinLimit
                               ,UINT32 unLimitVal
                               ,UINT8 unStep
                               ,int lFactScale
                               ,int lDotNum
...
void SetValDialog::on_reduceButton_pressed()
{
    ...
    unLine >= m_unMinLimitVal ? m_unMinLimitVal : unLine;
...
void SetValDialog::OnReduceTimer()
{
    ...
    unLine = unLine >= m_unMinLimitVal ? unLine : m_unMinLimitVal;
    ui->lineEdit->setText(ValueToString(unLine,m_lFactScale,m_lDotNum));
}
