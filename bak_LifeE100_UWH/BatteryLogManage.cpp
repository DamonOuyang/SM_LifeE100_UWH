...
BatteryLogManage::BatteryLogManage(QWidget *parent) : QWidget(parent)
{
	...
	disColorStart = QColor(255, 255, 255);
    disColorEnd = QColor(255, 255, 255);
...
void BatteryLogManage::drawBg(QPainter *painter)
{
    ...
    {   
		...
		{
	        batteryGradient.setColorAt(0.0, disColorStart);
	        batteryGradient.setColorAt(1.0, disColorEnd);
		}
    }
...
void BatteryLogManage::setValue(int value, bool bDisFlg)
{
    bDischargeFlg = bDisFlg;
