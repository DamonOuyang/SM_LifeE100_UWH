...
#define MAX_CMD_TYPE_COUNT      20      //最大命令类型个数
...
#define  CTRL_CAL_ZERO_SND      0x09 //校正零值
#define  CTRL_DEV_STA_SND       0x0A //设置下位机与上位机一致
#define  CTRL_ALM_STA_SND       0x0B //发送告警级别下位机与上位机一致
#define  CTRL_BAT_STA_SND       0x0C //发送电池状态下位机与上位机一致
...
public:
	...
	virtual void SetTimeOutEnable(void);
