/****************************************************************************
** Meta object code from reading C++ file 'cpassworddlg.h'
**
...
#error "The header file 'cpassworddlg.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_CPasswordDlg[] = {
    "CPasswordDlg\0\0OnClickOK()\0OnClickCancel()\0"
    "OnItemEdit()\0old,now\0"
...
void CPasswordDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        CPasswordDlg *_t = static_cast<CPasswordDlg *>(_o);
        switch (_id) {
        case 0: _t->OnClickOK(); break;
        case 1: _t->OnClickCancel(); break;
        case 2: _t->OnItemEdit(); break;
...
const QMetaObject CPasswordDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CPasswordDlg,
