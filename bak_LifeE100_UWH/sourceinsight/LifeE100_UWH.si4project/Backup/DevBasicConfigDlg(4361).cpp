...
void DevBasicConfigDlg::OnItemEdit(void)
{
    if(m_pCurLineEdit==m_pBrdRate[0]||\
	   ...
	   m_pCurLineEdit==m_pComPort[0]||\
	   m_pCurLineEdit==m_pComPort[1]||\
	   m_pCurLineEdit==m_pComPort[2]||\
	   m_pCurLineEdit==m_pComPort[3]||\
	   m_pCurLineEdit==m_pComPort[4]||\
