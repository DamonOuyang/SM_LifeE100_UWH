...
void configArtFrame::OnClickOK(void)
{
	...
	g_devConfigInfo_Edt.arteryParm.unPressLimt = GetItemValue(m_pPressLimt,10);
...
void configArtFrame::OnUpdParams(void)
{
	...
	m_pPressLimt->setText(ValueToString(g_devConfigInfo_Edt.arteryParm.unPressLimt,10,1));
