...
#endif
{
	...
	//g_pRs485BatteryThread = new Rs485BatteryThread();
...
void MainWindow::PreSpeedLEClick(void)
{
    ...
    if(m_pCurLineEdit == NULL)
    {
		...
		setValDialog.SetValLimit(g_devConfigInfo.arteryParm.unSpeedLimt,SET_STEP_1,1,0,10);
	    setValDialog.setWindowModality(Qt::ApplicationModal);
	    setValDialog.exec();
    }
	else
...
void MainWindow::PreSpeedLEClickV(void)
{
    ...
    if(m_pCurLineEdit == NULL)
    {
		...
		//setValDialog.SetValLimit(SET_SPEED_LIMIT,SET_STEP_1,1,0,10);
		setValDialog.SetValLimit(g_devConfigInfo.veinParm.unSpeedLimt,SET_STEP_1,1,0,10);
	    setValDialog.setWindowModality(Qt::ApplicationModal);
	    setValDialog.exec();
    }
	else
