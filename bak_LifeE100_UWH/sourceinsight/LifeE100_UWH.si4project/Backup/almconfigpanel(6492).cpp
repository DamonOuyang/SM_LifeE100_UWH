    ...
    QFrame(parent)
{
	...
	AddItem(pFrmLayout,m_pAlmBubblA,tr("汽包上限:"),tr("(mm)"),lEditWidth+60);
	...
	AddItem(pFrmLayout,m_pAlmBubblV,tr("汽包上限:"),tr("(mm)"),lEditWidth+60);	
    ...
    pLeftGrpBox->setLayout(pFrmLayout);
