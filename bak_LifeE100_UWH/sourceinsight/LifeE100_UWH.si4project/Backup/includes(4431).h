...
#define SET_PRESS_LIMIT     1000
#define SET_STEP_5          5
#define SET_PRESS_STP       900 //最好停止灌注压力
#define SET_AUTO_PRESS      400 //设置压力回到默认值
...
//告警消除值差
#define MAX_ALM_PRES_DIF        20
#define MAX_ALM_FLOW_DIF        5
...
{
    UINT8  unDataType;   //数据类型
    UINT16 unASpeeSet;	//转速(RPM)设定值
    UINT16 unAPrssSet;	//压力(mmHg)设定值
    //动脉
    INT16 unATmpVal;	//温度(℃)
...
#define OPER_LOG_TYPE_PUM  5  //血泵模块配置

#define OPER_CTRL_TYPE_PUM  6  //泵启停
