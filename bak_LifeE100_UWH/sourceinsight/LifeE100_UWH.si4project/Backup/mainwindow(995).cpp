...
void MainWindow::on_wtrTmpSetBt_clicked()
{
    ...
    if(m_pCurLineEdit == NULL)
    {
		...
		setValDialog.SetValLimit(g_devConfigInfo.watRooParam.unTmpValLimt,SET_STEP_1,10,1,1);
...
void MainWindow::PourPressLEClick(void)
{
	...
	if(m_pCurLineEdit == NULL)
	{
		...
		setValDialog.SetValLimit(g_devConfigInfo.arteryParm.unPressLimt,SET_STEP_5*2,10,1,1);
	    setValDialog.setWindowModality(Qt::ApplicationModal);
	    setValDialog.exec();
	}
	else
...
void MainWindow::PreSpeedLEClick(void)
{
    ...
    if(m_pCurLineEdit == NULL)
    {
		...
		setValDialog.SetValLimit(g_devConfigInfo.arteryParm.unSpeedLimt,SET_STEP_100,1,0,10);
	    setValDialog.setWindowModality(Qt::ApplicationModal);
	    setValDialog.exec();
    }
	else
...
void MainWindow::PourPressLEClickV(void)
{
	...
	if(m_pCurLineEdit == NULL)
	{
		...
		setValDialog.SetValLimit(g_devConfigInfo.veinParm.unPressLimt,SET_STEP_1,10,1,1);
	    setValDialog.setWindowModality(Qt::ApplicationModal);
	    setValDialog.exec();
	}
	else
...
void MainWindow::PreSpeedLEClickV(void)
{
    ...
    if(m_pCurLineEdit == NULL)
    {
		...
		//setValDialog.SetValLimit(SET_SPEED_LIMIT,SET_STEP_1,1,0,10);
		setValDialog.SetValLimit(g_devConfigInfo.veinParm.unSpeedLimt,SET_STEP_100,1,0,10);
	    setValDialog.setWindowModality(Qt::ApplicationModal);
	    setValDialog.exec();
    }
	else
