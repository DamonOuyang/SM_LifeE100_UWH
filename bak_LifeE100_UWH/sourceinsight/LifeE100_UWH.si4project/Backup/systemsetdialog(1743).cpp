...
#endif    
{
	...
	pBackBut->setObjectName(QStringLiteral("pBackBut"));
	pBackBut->setGeometry(QRect(1080, 20, 160, 60));
	QIcon icon;
	icon.addFile(QStringLiteral(":/images/sysSetBack_Bt.png"), QSize(), QIcon::Normal, QIcon::Off);
