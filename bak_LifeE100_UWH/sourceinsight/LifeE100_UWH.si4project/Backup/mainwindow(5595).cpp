...
void MainWindow::FlashPumpAInfo(void)
{
    ...
    if(m_unPourStaA == STR_POUR && pumDevData.unPrssVal > 0 && pumDevData.unFlowVal > 0)
    {
        UINT16 unFloR = pumDevData.unPrssVal*100;
...
void MainWindow::FlashPumpVInfo(void)
{
    ...
    if(m_unPourStaV == STR_POUR && pumDevData.unPrssVal > 0 && pumDevData.unFlowVal > 0)
    {
        UINT16 unFloR = pumDevData.unPrssVal*100;
		unFloR = unFloR/pumDevData.unFlowVal;
