...
"}"));
        ...
        icon1.addFile(QStringLiteral(":/images/prePourDis_Icon.png"), QSize(), QIcon::Disabled, QIcon::On);
...
"}"));
        ...
        icon2.addFile(QStringLiteral(":/images/pourDis_Icon.png"), QSize(), QIcon::Disabled, QIcon::Off);
...
"}"));
        ...
        icon3.addFile(QStringLiteral(":/images/alarmOff_Icon.png"), QSize(), QIcon::Disabled, QIcon::Off);
        ...
        sysSetBtn->setStyleSheet(QLatin1String("#sysSetBtn{\n"
"background: transparent;\n"
"border-width:-1px;\n"
"padding:-1px;\n"
"}\n"
...
"}"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/images/sysSet_Icon.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/images/unLocking_Icon.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/images/BP_Stop_Icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon6.addFile(QStringLiteral(":/images/BP_Start_Icon.png"), QSize(), QIcon::Normal, QIcon::On);
...
"}"));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/images/vBP_Stop_Icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon7.addFile(QStringLiteral(":/images/vBP_Start_Icon.png"), QSize(), QIcon::Normal, QIcon::On);
...
"}"));
        ...
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/images/prePourOff_Icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon8.addFile(QStringLiteral(":/images/prePourOn_IconV.png"), QSize(), QIcon::Normal, QIcon::On);
        icon8.addFile(QStringLiteral(":/images/prePourDis_IconV.png"), QSize(), QIcon::Disabled, QIcon::On);
...
"}"));
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/images/pourOff_Icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon9.addFile(QStringLiteral(":/images/pourOn_IconV.png"), QSize(), QIcon::Normal, QIcon::On);
        icon9.addFile(QStringLiteral(":/images/pourDis_Icon.png"), QSize(), QIcon::Disabled, QIcon::Off);
...
""));
        ...
        batSocLabel->setObjectName(QStringLiteral("batSocLabel"));
        batSocLabel->setGeometry(QRect(1116, 11, 38, 18));
        batSocLabel->setStyleSheet(QLatin1String("#batSocLabel\n"
"{\n"
"background: transparent;\n"
"color:rgb(255,255,255);\n"
"font-family:simhei;\n"
...
"}"));
        ...
        batLinkLog = new QLabel(centralWidget);
        batLinkLog->setObjectName(QStringLiteral("batLinkLog"));
        batLinkLog->setGeometry(QRect(1203, 12, 37, 18));
        batLinkLog->setStyleSheet(QLatin1String("#batLinkLog{\n"
"	background-image: url(:/images/batteryLink_Icon.png);\n"
"}"));
        batLinkLog->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
