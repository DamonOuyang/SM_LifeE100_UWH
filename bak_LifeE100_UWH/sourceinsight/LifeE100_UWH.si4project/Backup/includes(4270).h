...
#define H_ALM_ITEM_V_PRE_UP    0x01    //静脉泵-压力高

//动脉控制	动脉压力高	生理报警	灌注模式下，85<动脉压力<200 mmHg	高	2		动脉压力高	"界面：报警栏红色高亮，喇叭红色高亮
//声音：喇叭报警
//灯光：指示灯显示红色"
#define H_ALM_ITEM_A_PRE_UP    0x02    //动脉泵-压力高

//门脉控制	门脉压力低	生理报警	灌注模式下：门脉压力<0 mmHg	高	3		门脉压力传感器异常	
#define H_ALM_ITEM_V_PRE_DN    0x03    //静脉泵-压力低
...
//声音：喇叭报警
//灯光：指示灯显示红色"
#define H_ALM_ITEM_A_PRE_DN    0x04    //动脉泵-压力低
...
//门脉控制	门脉气泡报警	生理报警	门脉3秒内检测到3个气泡	高	23		门脉管路有气泡	

//门脉控制	门脉流量传感器未连接	技术报警	门脉流量传感器未连接	中	36		门脉流量传感器未连接	

//门脉控制	门脉流量传感器未连接	生理报警	门脉血液温度> 38℃	高	7		门脉血液温度高	
...
//血泵传感器编位
#define PUM_TMP_BITS  0x0001
#define PUM_FLO_BITS  0x0002
#define PUM_PRE_BITS  0x0004
#define PUM_SPE_BITS  0x0008
//水浴传感器编位
#define WAT_TMP_BITS  0x0001
#define WAT_LIN_BITS  0x0002
...
typedef struct PUM_GRP_ALM_BITS
{
    ...
    BYTE bPressSensorBits:1; //压力传感器异常
    BYTE bSpeeSensorBits:1; //转速传感器异常
...
{
	UINT16 unBatTmp;  //总电压  2BYTE,单位 10mV，高字节在前，下同
	UINT16 unBatVol;  //剩余容量  2BYTE，单位 10mAh
	INT16  unBatCur;  //电流  2BYTE，单位 10mA  通过电流判断电池充放电状态，充电为正，放电为负。
    UINT8  unBatSoc;  //Soc
}BqBatBascInfo;
