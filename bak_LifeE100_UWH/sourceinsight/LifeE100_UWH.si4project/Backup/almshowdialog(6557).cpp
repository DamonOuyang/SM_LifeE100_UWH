...
void AlmShowDialog::AddRTAlarmTab(void)
{
   ...
   // m_pRTItemModel->setHeaderData(0,Qt::Horizontal,QColor(54, 54, 61),Qt::ForegroundRole);
   
	//ui->userTableWidget->setStyleSheet("background-color:transparent;");	//整个表格透明
    m_pRTAlmTabView->horizontalHeader()->setStyleSheet("QHeaderView::section{background-color:transparent;font:13pt '宋体';color: white;}");  //行表头
    m_pRTAlmTabView->verticalHeader()->setStyleSheet("QHeaderView::section{background-color:transparent;font:13pt '宋体';color: white;}");    //列表头
