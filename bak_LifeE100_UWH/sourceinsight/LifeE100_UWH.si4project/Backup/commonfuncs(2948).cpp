...
void InitDefParam(void)
{
    ...
    g_devConfigInfo.devAlmParam.unAlmUPresV = 12;
    ...
    g_devConfigInfo.devPourParam.unPourUPresV = 30;
...
{
    int  fd;
    QString strVersion  = QString("版本：%1").arg(VERSION_INFO);
