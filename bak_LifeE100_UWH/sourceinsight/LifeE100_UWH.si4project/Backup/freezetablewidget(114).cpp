...
FreezeTableWidget::FreezeTableWidget(QAbstractItemModel * model)
{
      ...
      init();
     // QHeaderView *pQHeaderView;
      //pQHeaderView = new QHeaderView(this);
	  //connect(m_pPourPressLE, SIGNAL(clicked()),this, SLOT(PourPressLEClick(void)));

      //connect the headers and scrollbars of both tableviews together
      connect(horizontalHeader(),SIGNAL(clicked()),this,SLOT(updateSectionWidth(int,int,int)));

      //connect(horizontalHeader(), &QHeaderView::sectionResized,this,SLOT(updateSectionWidth(int,int,int)));
      ...
      //connect(frozenTableView->verticalScrollBar(), SIGNAL(QAbstractSlider::valueChanged(int)),verticalScrollBar(),SLOT(QAbstractSlider::setValue(int)));
