    ...
    if(NULL!= m_pWorkThread)
    {
        ...
        else if("CSwitWater"==strClsName)
        {
                                      ...
                                      m_unDevID,0x00,unTmtCount,unAlmFlag))
            {
                if(1==unAlmFlag)
                {
                    g_devAlmBits.unWatModBits = bVal;
        ...
        else if("CBq40z50Bat"==strClsName)
        {
                                      ...
                                      m_unDevID,0x00,unTmtCount,unAlmFlag))
            {
                if(1==unAlmFlag)
                {
                    g_devAlmBits.unBatModBits = bVal;
