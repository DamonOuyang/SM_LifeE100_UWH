    ...
    QFrame(parent)
{
    ...
    strItems<<tr("基本--配置");//基本配置
    strItems<<tr("告警--配置");//告警配置
	strItems<<tr("灌注--配置");//灌注配置
    strItems<<tr("水浴--模块");//水浴模块
    strItems<<tr("血泵--动脉");//血泵动脉
    strItems<<tr("血泵--静脉");//血泵门脉
	//strItems<<tr("血泵--脉搏");
    strItems<<tr("调试信息");//调试信息
