...
void AlmConfigPanel::OnClickOK(void)
{
    ...
    //压力上限告警值比保护值小10
	if(operLogAlm.unAlmUPresA[1] > (g_devConfigInfo.devPourParam.unPourUPresA-100))
	{
		operLogAlm.unAlmUPresA[1] = g_devConfigInfo.devPourParam.unPourUPresA-100;
	}
...
//---------------动脉-------------------
    ...
    //压力上限告警值比保护值小10
	if(g_devConfigInfo_Edt.devAlmParam.unAlmUPresA > (g_devConfigInfo.devPourParam.unPourUPresA-100))
	{
		g_devConfigInfo_Edt.devAlmParam.unAlmUPresA = g_devConfigInfo.devPourParam.unPourUPresA-100;
...
//---------------------静脉-------------------------------
    ...
    //压力上限告警值比保护值小10
	if(g_devConfigInfo_Edt.devAlmParam.unAlmUPresV > (g_devConfigInfo.devPourParam.unPourUPresV-100))
	{
		g_devConfigInfo_Edt.devAlmParam.unAlmUPresV = g_devConfigInfo.devPourParam.unPourUPresV-100;
