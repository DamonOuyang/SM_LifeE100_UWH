#ifndef BATTERYLOGMANAGE_H
#define BATTERYLOGMANAGE_H

#include <QWidget>

class BatteryLogManage : public QWidget
{
    Q_OBJECT
...
public:
    explicit BatteryLogManage(QWidget *parent = 0);
    ~BatteryLogManage();
...
private:
    ...
    QColor disColorStart;       //电池正常放电渐变开始颜色
    QColor disColorEnd;         //电池正常放电渐变结束颜色
...
public Q_SLOTS:
    ...
    void setValue(int value, bool bDisFlg);
