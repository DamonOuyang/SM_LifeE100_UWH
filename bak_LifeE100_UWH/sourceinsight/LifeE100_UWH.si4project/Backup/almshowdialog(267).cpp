...
void AlmShowDialog::AddRTAlarmTab(void)
{
    ...
    m_pRTAlmTabView->horizontalHeader()->setStyleSheet("QHeaderView::section{background-color:transparent;color:white;}");  //行表头
...
void AlmShowDialog::AddDataAlarmTab(void)
{
    ...
    m_pInfoView->horizontalHeader()->setStyleSheet("QHeaderView::section{background-color:transparent;color:white;}");  //行表头
