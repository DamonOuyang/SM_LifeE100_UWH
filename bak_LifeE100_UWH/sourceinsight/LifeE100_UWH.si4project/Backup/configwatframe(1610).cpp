    ...
    ui(new Ui::configWatFrame)
{
    ...
    m_pTmpVal = new QLineEdit(this);  //水浴温度设置�?    m_pTmpVal->setGeometry(QRect(155, 225, 100, 36));
	
	m_pTmpValLimt = new QLineEdit(this);  //水浴温度设置�?    m_pTmpValLimt->setGeometry(QRect(496, 85, 100, 36));
