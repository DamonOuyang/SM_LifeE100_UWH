...
public:
  ...
  */
  ...
  void setTooltipPen(QPen pen);
  void SetShowBarValText(bool bShowBarValFlag,double dbDegree);
...
protected:
  ...
  bool   m_bShowBarValFlag;
  double m_dBarValTextRotation;
  
  QPen m_penTooltip;
  void DrawBarValText(QCPPainter*painter,QPointF pPointF,QString strValText);
  // reimplemented virtual methods:
  virtual void draw(QCPPainter *painter);
  virtual void drawLegendIcon(QCPPainter *painter, const QRectF &rect) const;
  virtual QCPRange getKeyRange(bool &foundRange, SignDomain inSignDomain=sdBoth) const;
