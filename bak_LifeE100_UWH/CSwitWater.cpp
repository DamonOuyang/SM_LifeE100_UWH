...
void CSwitWater::DataParser(BYTE* pDataBuf,UINT32 unCmdID,UINT32 unDataLen)
{
    ...
    switch(unCmdID)
    {
		...
		if(unDataLen <= sizeof(WatDevData))
		{
            ...
            m_bGetData = true;
			//printf("CSwitWater::unDevCode:%lu ---unWatLine:%u---- unBloodSta:%u \r\n",m_pWaterData.unDevCode,m_pWaterData.unWatLine,m_pWaterData.unBloodSta);
	    ...
	    case CMD_SND_BAT_STA_ACK:
			printf("WatDevData::CMD_SND_BAT_STA_ACK \r\n");
